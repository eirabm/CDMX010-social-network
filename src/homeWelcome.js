        ...
        <div class= "homeWelcome-info-container--background">
            ...
            <div class= "homeWelcome-main-container">
                <form action="" name="logInForm">
                    ...
                    <label for="userEmail">Escribe tu correo</label>
                    <input id= "userEmail" type="email" required>
                    <label for="userPassword">Escribe tu contraseña</label>
                    <input id= "userPassword" type="text" required>
                </form>
                <button>Iniciar sesión</button>
                <div class= "homeWelcome-main--icons-container">
                    <p>Acceder usando:</p>
                    <a href=""><img src="https://user-images.githubusercontent.com/75234502/106777351-890d7a00-660a-11eb-9dd0-274d161e7242.png" alt="ícono Facebook"></a>
                    <a href=""><img src="https://user-images.githubusercontent.com/75234502/106777620-c3771700-660a-11eb-9e26-e581a32440f3.png" alt="ícono Instagram"></a>
                    <a href=""><img src="https://user-images.githubusercontent.com/75234502/106777436-9aef1d00-660a-11eb-965f-a0c88b46c7ff.png" alt="ícono Gmail"></a>
                </div>
                <p class= "homeWelcome-main--invitation">¿No eres miembro todavía?</p>
                <a href="" class= "homeWelcome-main--signUp">Regístrate aquí</a>
            </div>
        </div>
    </div>
    `;
